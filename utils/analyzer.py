...
# Load word lists from JSON files or use minimal defaults
...
# Minimal default lists for fallback
...
def extract_key_values(text, keywords, brand_name=""):
    ...
    sentences = sent_tokenize(text) if nltk_resources_available else text.split('. ')
