...
POSITIVE_WORDS = {
    'good', 'great', 'excellent', 'amazing', 'wonderful', 'best', 'love', 'happy', 'positive',
    'success', 'successful', 'innovative', 'quality', 'reliable', 'trusted', 'leading', 'premium',
    'outstanding', 'perfect', 'impressive', 'exceptional', 'fantastic', 'fabulous', 'brilliant',
    'delightful', 'helpful', 'favorable', 'superior', 'pleasant', 'remarkable', 'satisfying',
    'skilled', 'stunning', 'supportive', 'terrific', 'thriving', 'valuable', 'versatile',
    'vibrant', 'worthy', 'abundant', 'accomplished', 'achieving', 'active', 'adept', 'admirable',
    'adorable', 'adored', 'advanced', 'advantageous', 'appealing', 'appreciated', 'authentic',
    'beautiful', 'beneficial', 'blissful', 'bountiful', 'brave', 'bright', 'brilliant',
    'capable', 'celebrated', 'champion', 'charming', 'cherished', 'choice', 'classic', 'clean',
    'clear', 'clever', 'collaborative', 'committed', 'competent', 'complete', 'comprehensive',
    'confident', 'consistent', 'convenient', 'creative', 'credible', 'customer-focused',
    'dazzling', 'dedicated', 'delicious', 'delightful', 'dependable', 'deserving', 'desirable',
    'determined', 'devoted', 'diligent', 'distinguished', 'dreamy', 'driven', 'dynamic',
    'easy', 'economical', 'educated', 'effective', 'efficient', 'effortless', 'elegant',
    'elite', 'empowering', 'enchanting', 'encouraging', 'endorsed', 'energetic', 'engaging',
    'enhanced', 'enjoyable', 'enlightened', 'enriching', 'enthusiastic', 'essential', 'esteemed',
    'ethical', 'excellent', 'exclusive', 'exemplary', 'exquisite', 'extraordinary', 'exuberant'
}

NEGATIVE_WORDS = {
    'bad', 'poor', 'terrible', 'awful', 'worst', 'hate', 'sorry', 'negative', 'difficult',
    'problem', 'failure', 'concern', 'disappointing', 'disappointed', 'fail', 'failed', 'failing',
    'poor', 'poorly', 'subpar', 'mediocre', 'inferior', 'useless', 'broken', 'abysmal', 'adverse',
    'alarming', 'angry', 'annoying', 'anxious', 'appalling', 'atrocious', 'awful', 'banal',
    'boring', 'broken', 'callous', 'clumsy', 'coarse', 'cold', 'confused', 'contradictory',
    'contrary', 'corrosive', 'corrupt', 'crazy', 'creepy', 'criminal', 'cruel', 'damaging',
    'daunting', 'dead', 'decaying', 'deformed', 'denied', 'deplorable', 'depressed', 'deprived',
    'despicable', 'detrimental', 'dirty', 'disgusting', 'dishonest', 'dishonorable', 'dismal',
    'distress', 'disturbed', 'dreadful', 'dreary', 'enraged', 'eroding', 'evil', 'faulty',
    'feeble', 'filthy', 'foul', 'frightful', 'frustrating', 'ghastly', 'grave', 'greedy',
    'grim', 'grimace', 'gross', 'grotesque', 'gruesome', 'guilty', 'haggard', 'hard', 'harmful',
    'harsh', 'hideous', 'horrendous', 'horrible', 'hostile', 'hurt', 'hurtful', 'icky',
    'ignorant', 'ill', 'immature', 'imperfect', 'impossible', 'inaccurate', 'inadequate',
    'incomplete', 'incorrect', 'ineffective', 'inefficient', 'inferior', 'injurious', 'insane',
    'insidious', 'insipid', 'intimidating', 'irrational', 'irritating', 'lackadaisical', 'lazy'
}

VALUE_INDICATORS = {
    'mission', 'vision', 'values', 'believe', 'committed', 'dedication', 'quality', 'innovation',
    'excellence', 'integrity', 'sustainability', 'responsibility', 'trust', 'community',
    'service', 'customer', 'passion', 'creativity', 'diversity', 'inclusion', 'empowerment',
    'care', 'caring', 'authentic', 'authenticity', 'accountable', 'accountability', 'transparent',
    'transparency', 'ethical', 'ethics', 'respect', 'respectful', 'honesty', 'honest', 'reliable',
    'reliability', 'teamwork', 'collaboration', 'collaborative', 'people', 'performance',
    'solution', 'solutions', 'driven', 'focus', 'focused', 'future', 'forward', 'growth',
    'leading', 'leader', 'leadership', 'expert', 'expertise', 'professional', 'professionalism',
    'standard', 'standards', 'results', 'pride', 'proud', 'commitment', 'deliver', 'delivering',
    'success', 'successful', 'support', 'supporting', 'satisfaction', 'satisfying', 'value',
    'valued', 'develop', 'developing', 'development', 'partner', 'partnership'
}

BRAND_ATTRIBUTES = {
    'reliable', 'innovative', 'premium', 'quality', 'affordable', 'luxury', 'sustainable',
    'eco-friendly', 'cutting-edge', 'traditional', 'modern', 'trusted', 'authentic', 'responsive',
    'personal', 'professional', 'expert', 'specialized', 'global', 'local', 'fast', 'efficient',
    'friendly', 'approachable', 'exclusive', 'inclusive', 'comprehensive', 'seamless', 'intuitive',
    'flexible', 'adaptable', 'customized', 'custom', 'personalized', 'accessible', 'secure',
    'safe', 'reliable', 'consistent', 'dynamic', 'energetic', 'passionate', 'creative',
    'innovative', 'forward-thinking', 'visionary', 'established', 'experienced', 'knowledgeable',
    'respected', 'renowned', 'acclaimed', 'award-winning', 'advanced', 'sophisticated', 'elegant',
    'simple', 'minimalist', 'practical', 'effective', 'powerful', 'robust', 'versatile',
    'comprehensive', 'complete', 'holistic', 'integrated', 'streamlined', 'optimized', 'enhanced',
    'superior', 'exceptional', 'extraordinary', 'distinctive', 'unique', 'original', 'genuine',
    'authentic', 'natural', 'organic', 'fresh', 'clean'
}

DEFAULT_KEYWORDS = [
    "professional", "service", "quality", "experience", "solution", "innovation", "customer",
    "product", "industry", "leadership", "expertise", "excellence", "value", "team", "performance"
]

DEFAULT_KEY_VALUES = [
    'Quality', 'Innovation', 'Customer Focus', 'Excellence', 'Integrity'
]
...
def extract_keywords(tokens, top_n=15):
    ...
    priority_words = [word for word in top_words 
                ...
                if textblob_available:
                    try:
                        ...
                        for phrase in sentence_blob.noun_phrases:
                            if len(phrase.split()) <= 3:  # Keep phrases reasonably short
