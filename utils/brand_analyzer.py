...
# Add these imports at the top of gemini_search.py
import re
import string
from collections import Counter
import os
...
# Remove NLTK imports and keep only TextBlob dependency
try:
...
# Copy the word list loading code
...
# Simplify tokenize_text to remove NLTK dependency
...
# Copy the rest of the analyzer functions with simpler sentence splitting
